...
!(function (e, t) {
   ...
   var m,
      ...
      I =
         ...
         (b.webView =
            !(!(C || T || E) || (!g.match(/.*AppleWebKit(?!.*Safari)/i) && !t.navigator.standalone)) || (t.matchMedia && t.matchMedia("(display-mode: standalone)").matches)),
         (b.webview = b.webView),
               ...
               if (r && (!r || 0 !== Object.keys(r).length)) {
                  ...
                  if (o && this.currentBreakpoint !== o) {
                     ...
                     h && !p
                        ...
                        : !h &&
                          p &&
                          (a.addClass(s.containerModifierClass + "multirow"), "column" === d.slidesPerColumnFill && a.addClass(s.containerModifierClass + "multirow-column"));
   ...
   var ie = {
      ...
      we = [
         ...
         },
         {
            ...
            create: function () {
               n.extend(this, {
                  pagination: { init: ae.init.bind(this), render: ae.render.bind(this), update: ae.update.bind(this), destroy: ae.destroy.bind(this), dynamicBulletIndex: 0 },
               });
            },
            on: {
               init: function () {
            ...
            return this.runValidators(r).done(function (e) {
               r.data("bs.validator.errors", e),
                  ...
                  (i && e.toString() === i.toString()) ||
                     ((o = e.length ? t.Event("invalid.bs.validator", { relatedTarget: r[0], detail: e }) : t.Event("valid.bs.validator", { relatedTarget: r[0], detail: i })),
                     s.$element.trigger(o)),
                  s.toggleSubmit(),
