(function ($, WOW, Swiper) {
   ...
   $(document).on("ready", function () {
      ...
      function makeTimer() {
         ...
         $("#hours").html(sHours + "<span>Hours</span>");
         $("#minutes").html(sMinutes + "<span>Minutes</span>");
         $("#seconds").html(sSeconds + "<span>Seconds</span>");
      }
...
})(globalThis.jQuery, globalThis.WOW, globalThis.Swiper);
