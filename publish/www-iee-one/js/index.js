(() => {
   class Api {
      async getList() {
         let list = await fetch("https://w.iee.one/api/mds/list").then(async (res) => {
   ...
   function showGoogle() {
      ...
      script.src = "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2208954604036695";
